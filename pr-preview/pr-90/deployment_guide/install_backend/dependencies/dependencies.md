...
OSMO uses [KAI scheduler](https://github.com/NVIDIA/kai-scheduler) to run AI workflows at very large scale with [Workflow Groups](https://nvidia.github.io/OSMO/user_guide/main/tutorials/parallel_workflows/index.html#groups).
