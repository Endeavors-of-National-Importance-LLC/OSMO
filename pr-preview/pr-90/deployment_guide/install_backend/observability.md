...
Once configured, you can access dashboard and resource usage links for each workflow in the OSMO UI. See the [Workflow Resource Usage](https://nvidia.github.io/OSMO/user_guide/main/faq/index.html#how-to-determine-the-resource-usage-of-a-workflow) for details.
