...
![Alternative text](getting_started/create_storage/gcp/organization1.png)
1. In the popup, Click on the drop down field to select your organization.

![Alternative text](getting_started/create_storage/gcp/organization2.png)
1. Click on the `ALL` tab, search for your project, and click on it.

![Alternative text](getting_started/create_storage/gcp/organization3.png)
...
![Alternative text](getting_started/create_storage/gcp/iam.png)

Click on `Role` in the left task bar.

![Alternative text](getting_started/create_storage/gcp/role1.png)

Click on `Create Role` to create a custom role.

![Alternative text](getting_started/create_storage/gcp/role2.png)
...
![Alternative text](getting_started/create_storage/gcp/role3.png)
