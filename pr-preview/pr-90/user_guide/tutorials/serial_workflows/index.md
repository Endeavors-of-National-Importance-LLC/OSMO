...
![Data Flow](tutorials/serial_workflows/data_flow.svg)
```yaml
tasks:
- name: task1
...
![Serial Workflow](tutorials/serial_workflows/serial_workflow.svg)
```yaml
...
![Conditional Execution](tutorials/serial_workflows/conditional_execution.svg)
```yaml
tasks:
