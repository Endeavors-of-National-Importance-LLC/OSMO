...
![image](getting_started/install/github_assets_light.png)![image](getting_started/install/github_assets_dark.png)<img src="../../_images/github_assets_dark.png" alt="GitHub assets" class="theme-image-light" style="margin-bottom: 1em;">
...
![Login and grant access to OSMO application](getting_started/install/login1.png)

After successful authentication, you are logged in. Welcome to OSMO.

![Successfully logged in](getting_started/install/login2.png)
```bash
